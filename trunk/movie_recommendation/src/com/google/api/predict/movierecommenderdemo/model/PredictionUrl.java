...
package com.google.api.predict.movierecommenderdemo.model;

import com.google.api.client.googleapis.GoogleUrl;
import com.google.api.client.util.Key;

/**
 * Prediction API URL builder.
 * 
 * @author Yaniv Inbar
 * @author Max Lin
 */
public final class PredictionUrl extends GoogleUrl {
  ...
  private static PredictionUrl root() {
    return new PredictionUrl("https://www.googleapis.com/prediction/v1.1/training");
  }
